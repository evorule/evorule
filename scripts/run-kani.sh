...
#
# 支持 evorule-tcb (12 proofs) 和 evorule-reactor (11 proofs,CI 子集 3 个)。
...
#
# 用法:
#   ./scripts/run-kani.sh                              # 跑 evorule-tcb 所有 proofs
...
# Validate crate
case "$CRATE" in
    evorule-tcb|evorule-reactor) ;;
    *)
        err "Invalid crate: $CRATE (expected: evorule-tcb or evorule-reactor)"
        exit 1
        ;;
esac
