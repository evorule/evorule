...
//
// NOTE: pkg/ is an ES module produced by `wasm-bindgen --target web`; the wasm
// instance must be initialized before any export is called. Use the same
// initSync-from-bytes pattern as test.js (require() + direct call throws
...
async function main() {
  ...
  mod.initSync({ module: readFileSync(path.join(PKG_DIR, 'evorule_wasm_demo_bg.wasm')) });
