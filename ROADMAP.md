...
> **当前状态**:v0.1.0-alpha.1 公开基座(2026-07-20)。详见 [STATUS.md](STATUS.md)。
>
> 本文档是面向**外部读者**的精简版;内部详细计划见 [`docs/PLAN_v0.1.0-alpha.md`](docs/PLAN_v0.1.0-alpha.md)。
...
- ✅ **HTTP API** — 30+ 端点,完整覆盖会话/命令/状态/审计/调试
...
见 [`docs/PLAN_v0.1.0-alpha.md`](docs/PLAN_v0.1.0-alpha.md) — 8 项发版前 checklist + 4 阶段路线图。
...
候选(按 ROI 排):
- **Time-Travel Debugger** — 已完成 DESIGN.md (27 KB, 5 视图, 8 周)
...
具体每月详见 [`docs/PLAN_v0.1.0-alpha.md`](docs/PLAN_v0.1.0-alpha.md)。
