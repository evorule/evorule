...
| 版本                         | 支持状态       | 说明                         |
| ---------------------------- | -------------- | ---------------------------- |
| `v0.6.x`（含 0.6.0）         | ✅ Supported   | 当前主支持线（2026-09-14 发布） |
| `v0.2.x`（含 0.2.0）         | ❌ EOL         | 公开基座阶段，已被 0.6.x 取代  |
| `v0.1.x`（含 0.1.0 / 0.1.1） | ❌ Unsupported | 早期阶段，不维护              |
| `v6.0.x`（内部旧版）         | ❌ EOL         | 内部历史版本，已退役，无 Gitee 撤回成本 |
